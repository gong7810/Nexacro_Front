(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"authority_code\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"authority_code\">AU01</Col></Row><Row><Col id=\"authority_code\">AU02</Col></Row><Row><Col id=\"authority_code\">AU03</Col></Row><Row><Col id=\"authority_code\">AU04</Col></Row><Row><Col id=\"authority_code\">AU05</Col></Row><Row><Col id=\"authority_code\">AU06</Col></Row><Row><Col id=\"authority_code\">AU07</Col></Row><Row><Col id=\"authority_code\">AU08</Col></Row><Row><Col id=\"authority_code\">AU09</Col></Row><Row><Col id=\"authority_code\">AU10</Col></Row><Row><Col id=\"authority_code\">AU11</Col></Row><Row><Col id=\"authority_code\">AU12</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("auth_name", this);
            obj._setContents("<ColumnInfo><Column id=\"auth_name\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"auth_name\">전표입력</Col></Row><Row><Col id=\"auth_name\">기본설정</Col></Row><Row><Col id=\"auth_name\">장부관리</Col></Row><Row><Col id=\"auth_name\">결산 및 재무제표</Col></Row><Row><Col id=\"auth_name\">전기분재무제표</Col></Row><Row><Col id=\"auth_name\">예산관리</Col></Row><Row><Col id=\"auth_name\">권한관리</Col></Row><Row><Col id=\"auth_name\">고정자산관리</Col></Row><Row><Col id=\"auth_name\">게시판</Col></Row><Row><Col id=\"auth_name\">업무용차량관리</Col></Row><Row><Col id=\"auth_name\">어음명세서관리</Col></Row><Row><Col id=\"auth_name\">자금관리</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        	...
        	//innerdataset의 정보를 받아와서
        		var objDs=obj.getInnerDataset();
        			...
        			if(text=='전표입력'){
        				...
        				this.emp_auth_for_trasaction.setColumn(0,2,'AU12');
