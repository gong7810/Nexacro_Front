(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"DEPT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"DEPT_CODE\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"DEPT_NAME\">모든부서</Col></Row><Row><Col id=\"DEPT_NAME\">총무부</Col><Col id=\"DEPT_CODE\">DPT-01</Col></Row><Row><Col id=\"DEPT_NAME\">영업부</Col><Col id=\"DEPT_CODE\">DPT-02</Col></Row><Row><Col id=\"DEPT_NAME\">생산부</Col><Col id=\"DEPT_CODE\">DPT-03</Col></Row><Row><Col id=\"DEPT_NAME\">구매부</Col><Col id=\"DEPT_CODE\">DPT-04</Col></Row><Row><Col id=\"DEPT_NAME\">인사부</Col><Col id=\"DEPT_CODE\">DPT-05</Col></Row><Row><Col id=\"DEPT_NAME\">홍보부</Col><Col id=\"DEPT_CODE\">DPT-06</Col></Row><Row><Col id=\"DEPT_NAME\">개발부</Col><Col id=\"DEPT_CODE\">DPT-07</Col></Row></Rows>");
            this.addChild(obj.name, obj);
