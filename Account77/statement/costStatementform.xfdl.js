(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"ACCOUNT_INNER_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"ACCOUNT_NAME\" type=\"STRING\" size=\"256\"/><Column id=\"PARENT_ACCOUNT_CODE\" type=\"STRING\" size=\"256\"/><Column id=\"COST\" type=\"INT\" size=\"256\"/><Column id=\"COST_SUMMARY\" type=\"INT\" size=\"256\"/><Column id=\"PERIOD_NO\" type=\"INT\" size=\"256\"/><Column id=\"EARLY_COST\" type=\"INT\" size=\"256\"/><Column id=\"EARLY_COST_SUMMARY\" type=\"INT\" size=\"256\"/></ColumnInfo>");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"200\"/><Column size=\"220\"/><Column size=\"220\"/><Column size=\"220\"/><Column size=\"220\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" colspan=\"2\" text=\"당기\"/><Cell col=\"3\" colspan=\"2\" text=\"전기\"/><Cell row=\"1\" text=\"과목\"/><Cell row=\"1\" col=\"1\" text=\"세부금액\"/><Cell row=\"1\" col=\"2\" text=\"합계금액\"/><Cell row=\"1\" col=\"3\" text=\"세부금액\"/><Cell row=\"1\" col=\"4\" text=\"합계금액\"/></Band><Band id=\"body\"><Cell text=\"bind:ACCOUNT_NAME\"/><Cell col=\"1\" text=\"bind:COST\"/><Cell col=\"2\" text=\"bind:COST_SUMMARY\"/><Cell col=\"3\" text=\"bind:EARLY_COST\"/><Cell col=\"4\" text=\"bind:EARLY_COST_SUMMARY\" displaytype=\"number\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        // 		var eDate = eYear+"-"+eMonth+"-"+eDay;
        		...
        		var url = "svcStatement::costStatement";
        		var resData = "";
